...
#define _esp8266_putch EUSART1_Write 
#define _esp8266_getch EUSART1_Read   
...
unsigned char esp8266_server(unsigned char  );

void esp8266_CIPMUX(unsigned char);

void esp8266_SLEEP(unsigned char);

unsigned char esp8266_test();

inline unsigned char _esp8266_wrtest(void);
